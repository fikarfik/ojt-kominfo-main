        ...
        <div class="row">
                ...
                <form action="/admin/berita" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('slugFromTablePost') is-invalid @enderror"
                            ...
                            value="{{ old('slugFromTablePost') }}" required
                            autofocus>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control @error('imageFromTablePost') is-invalid @enderror"
                            name="imageFromTablePost" id="imageFromTablePost"
            ...
            <div class="col-12">
                <div class="form-group">
                    <label for="bodyFromTablePost"><b>Isi Berita</b></label>
                    <textarea name="bodyFromTablePost" id="bodyFromTablePost"></textarea>
                </div>
                <button type="submit" name ="submit" id="submit" class="btn mt-2 mb-5 float-center btn-primary">Posting</button>
            </div>
            </form>
        </div>
