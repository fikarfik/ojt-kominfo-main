      ...
      <tbody>
        @foreach ($showProfileFromController as $showingProfile)
          ...
          <tr>
            ...
            <td>
              <a href="/admin/profile/{{ $showingProfile->id }}"><span class="badge bg-primary text-decoration-none">Detail Profile</span></a>

              <a href="/admin/profile/{{ $showingProfile->id }}/edit"><span class="badge bg-warning text-decoration-none">Edit</span></a>
